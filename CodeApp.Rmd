...
El código App completo usado es el siguiente:
         ...
         sidebarLayout(sidebarPanel(
                ...
                mainPanel(tabsetPanel(type = "tabs",
                                      ...
                                      tabPanel(p(icon("table","fa-2x"),"Correlation"),br(),
                                               ...
                                               h5("The following table shows the correlation between the percentage of Achievement and other variables of interest."),htmlOutput("corr"),
                                               HTML('</br> </br>')),
...
server=function(input, output) {
        ...
        output$corr <- renderGvis({
                cor<-as.data.frame(sort(round(cor(DMAT[-c(18,19)]),2)[,8],decreasing=T)[-1])
                colnames(cor)<-"Coefficient R"
                cor <- cbind(Percentage_vs = rownames(cor), cor)
                gvisTable(cor)})
        # text model
